...
There is also another way to use it which is with p[strupload-auto](https://github.com/cvaldev/strupload-auto), which makes it so that your devices stay sync'd with Strava.
