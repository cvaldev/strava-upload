...
Repo for https://strava-upload.herokuapp.com/

Provides an API to easily upload files to Strava through the strava-upload-cli(Coming soon...), or through the web portal (Also coming soon...).
...
Authenticate with Strava and give the app permission to upload files to your profile. If using the website you can now upload your files :D. 
